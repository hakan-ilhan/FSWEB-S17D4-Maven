...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_2 = "SELECT * FROM ogrenci WHERE ogrenci.cinsiyet = 'K'";
    ...
    String QUESTION_4 = "SELECT * FROM ogrenci WHERE ogrenci.sinif = '10A' AND ogrenci.cinsiyet = 'K'";
    @Query(value = QUESTION_4, nativeQuery = true)
    List<Ogrenci> find10AGirls();

    //Öğrenci numarası 5 ile 10 arasında olan Kız öğrencileri listeleyiniz.
    String QUESTION_5 = "SELECT * FROM ogrenci WHERE ogrenci.ogrno > 5 AND ogrenci.ogrno < 10 AND ogrenci.cinsiyet = 'K'";
    ...
    String QUESTION_7 = "SELECT * FROM ogrenci WHERE ogrenci.sinif = '10A' ORDER BY ogrno DESC";
